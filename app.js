...
(function () {
      ...
      Object.assign(translations.en, {
        ...
        "Política de privacidad": "Privacy policy",
        "Responsable: ADONAI ELECTRICAL, RUT 220020810013, Av. Defensa 1599, Salto, Uruguay. Contacto: adonaielectrical2026@gmail.com.": "Data controller: ADONAI ELECTRICAL, tax ID (RUT) 220020810013, Av. Defensa 1599, Salto, Uruguay. Contact: adonaielectrical2026@gmail.com.",
        "Qué datos pedimos y para qué. Los datos que completás en el formulario —nombre, teléfono, tu correo si lo dejás y el texto de la consulta— se usan únicamente para responderte, evaluar el trabajo y preparar un presupuesto. No los vendemos, no los cedemos con fines comerciales y no los usamos para publicidad.": "What we collect and why. The details you enter in the form — name, phone, your email if you provide it, and the text of your enquiry — are used only to reply to you, assess the job and prepare a quote. We do not sell them, share them for commercial purposes or use them for advertising.",
        "Cómo se envía tu consulta. El formulario no envía nada por sí solo: arma el mensaje y abre WhatsApp en tu dispositivo para que lo mandes vos. Recién cuando lo enviás, el mensaje viaja por WhatsApp y queda sujeto también a las políticas de esa plataforma. Si preferís no usar WhatsApp, podés escribirnos por correo o llamarnos.": "How your enquiry is sent. The form sends nothing on its own: it composes the message and opens WhatsApp on your device so that you send it. Only when you send it does the message travel through WhatsApp, where that platform’s own policies also apply. If you would rather not use WhatsApp, you can email or call us.",
        "Qué guarda este sitio en tu navegador. No usamos cookies ni herramientas de analítica o publicidad. El sitio guarda en tu propio dispositivo dos preferencias, el idioma y el tema claro u oscuro, que no te identifican y podés borrar limpiando los datos del navegador.": "What this site stores in your browser. We use no cookies and no analytics or advertising tools. The site saves two preferences on your own device — language and light or dark theme — which do not identify you and which you can remove by clearing your browser data.",
        "Servicios de terceros. La tipografía se carga desde Google Fonts, por lo que tu dirección IP llega a los servidores de Google al abrir la página. Los enlaces a WhatsApp, Instagram, Facebook y Google Maps te llevan a sitios externos con sus propias políticas.": "Third-party services. The typeface is loaded from Google Fonts, so your IP address reaches Google’s servers when the page opens. Links to WhatsApp, Instagram, Facebook and Google Maps take you to external sites with their own policies.",
        "Cuánto tiempo los conservamos. Las consultas se conservan mientras dure la relación comercial y el plazo en que puedan derivarse responsabilidades por el trabajo realizado. Después se eliminan.": "How long we keep them. Enquiries are kept for as long as the working relationship lasts and for the period in which liability for the work could arise. After that they are deleted.",
        "Tus derechos. La Ley N° 18.331 de Protección de Datos Personales te da derecho a acceder a tus datos, rectificarlos, actualizarlos y pedir que se supriman. Para ejercerlos, escribinos a adonaielectrical2026@gmail.com. También podés presentar un reclamo ante la Unidad Reguladora y de Control de Datos Personales (URCDP).": "Your rights. Uruguayan Law No. 18,331 on Personal Data Protection gives you the right to access your data, correct it, update it and request its deletion. To exercise those rights, write to adonaielectrical2026@gmail.com. You may also file a complaint with the Personal Data Regulatory and Control Unit (URCDP).",
        "Última actualización: setiembre de 2026.": "Last updated: September 2026.",
        "Términos de uso": "Terms of use",
        "Alcance de la información. Los contenidos de este sitio son de carácter general. Las descripciones de servicios, los plazos y las imágenes no constituyen una oferta vinculante: cada trabajo se define en un presupuesto individual, con su alcance, precio y condiciones, que se confirma antes de comenzar.": "Scope of the information. The content of this site is general in nature. Service descriptions, timeframes and images are not a binding offer: every job is defined in an individual quote, with its own scope, price and conditions, confirmed before work begins.",
        "Contenido técnico. Los planos, esquemas y explicaciones técnicas que se muestran son material de referencia de trabajos propios. No sustituyen un relevamiento en obra ni un proyecto firmado, y no deben tomarse como guía para ejecutar una instalación por cuenta propia. Toda instalación que se conecte a las redes de UTE debe ser ejecutada por una firma instaladora y un técnico registrados.": "Technical content. The plans, diagrams and technical explanations shown are reference material from our own work. They do not replace an on-site survey or a signed project, and must not be used as a guide to carry out an installation yourself. Any installation connected to the UTE grid must be carried out by a registered installation firm and technician.",
        "Galería de trabajos. Las fotografías son registros de trabajos realizados. Cuando aparecen junto a un plano son ejemplos independientes: no documentan la ejecución de ese plano en particular.": "Work gallery. The photographs are records of completed work. When shown alongside a plan they are independent examples: they do not document the execution of that particular plan.",
        "Disponibilidad y emergencias. El servicio de emergencias se atiende las 24 horas, todos los días, sujeto a la disponibilidad del equipo y a la distancia del lugar. Los horarios de atención administrativa son los publicados en la sección Contacto.": "Availability and emergencies. The emergency service is available 24 hours a day, every day, subject to team availability and distance to the site. Administrative opening hours are those published in the Contact section.",
        "Propiedad intelectual. El nombre ADONAI ELECTRICAL, su logotipo, sus textos y sus imágenes son propiedad de la empresa y no pueden reproducirse ni utilizarse sin autorización escrita.": "Intellectual property. The ADONAI ELECTRICAL name, logo, texts and images are the property of the company and may not be reproduced or used without written permission.",
        "Enlaces externos. El sitio enlaza a plataformas de terceros —WhatsApp, Instagram, Facebook y Google Maps— sobre cuyo contenido y disponibilidad no tenemos control.": "External links. The site links to third-party platforms — WhatsApp, Instagram, Facebook and Google Maps — over whose content and availability we have no control.",
        "Ley aplicable. Estas condiciones se rigen por la legislación de la República Oriental del Uruguay.": "Governing law. These terms are governed by the laws of the Oriental Republic of Uruguay."
  });
      Object.assign(translations.pt, {
        ...
        "Qué datos pedimos y para qué. Los datos que completás en el formulario —nombre, teléfono, tu correo si lo dejás y el texto de la consulta— se usan únicamente para responderte, evaluar el trabajo y preparar un presupuesto. No los vendemos, no los cedemos con fines comerciales y no los usamos para publicidad.": "Quais dados pedimos e para quê. Os dados que você preenche no formulário — nome, telefone, seu e-mail se quiser deixá-lo e o texto da consulta — são usados apenas para responder, avaliar o trabalho e preparar um orçamento. Não os vendemos, não os cedemos com fins comerciais e não os usamos para publicidade.",
        "Cómo se envía tu consulta. El formulario no envía nada por sí solo: arma el mensaje y abre WhatsApp en tu dispositivo para que lo mandes vos. Recién cuando lo enviás, el mensaje viaja por WhatsApp y queda sujeto también a las políticas de esa plataforma. Si preferís no usar WhatsApp, podés escribirnos por correo o llamarnos.": "Como sua consulta é enviada. O formulário não envia nada sozinho: ele monta a mensagem e abre o WhatsApp no seu aparelho para que você a envie. Só quando você envia é que a mensagem passa pelo WhatsApp, ficando também sujeita às políticas dessa plataforma. Se preferir não usar o WhatsApp, escreva por e-mail ou ligue.",
        "Qué guarda este sitio en tu navegador. No usamos cookies ni herramientas de analítica o publicidad. El sitio guarda en tu propio dispositivo dos preferencias, el idioma y el tema claro u oscuro, que no te identifican y podés borrar limpiando los datos del navegador.": "O que este site guarda no seu navegador. Não usamos cookies nem ferramentas de análise ou publicidade. O site guarda no seu próprio aparelho duas preferências, o idioma e o tema claro ou escuro, que não identificam você e podem ser apagadas limpando os dados do navegador.",
        "Servicios de terceros. La tipografía se carga desde Google Fonts, por lo que tu dirección IP llega a los servidores de Google al abrir la página. Los enlaces a WhatsApp, Instagram, Facebook y Google Maps te llevan a sitios externos con sus propias políticas.": "Serviços de terceiros. A tipografia é carregada do Google Fonts, portanto seu endereço IP chega aos servidores do Google ao abrir a página. Os links para WhatsApp, Instagram, Facebook e Google Maps levam a sites externos com políticas próprias.",
        "Cuánto tiempo los conservamos. Las consultas se conservan mientras dure la relación comercial y el plazo en que puedan derivarse responsabilidades por el trabajo realizado. Después se eliminan.": "Por quanto tempo guardamos. As consultas são mantidas enquanto durar a relação comercial e pelo prazo em que possam surgir responsabilidades pelo trabalho realizado. Depois são excluídas.",
        "Tus derechos. La Ley N° 18.331 de Protección de Datos Personales te da derecho a acceder a tus datos, rectificarlos, actualizarlos y pedir que se supriman. Para ejercerlos, escribinos a adonaielectrical2026@gmail.com. También podés presentar un reclamo ante la Unidad Reguladora y de Control de Datos Personales (URCDP).": "Seus direitos. A Lei uruguaia n° 18.331 de Proteção de Dados Pessoais lhe dá direito a acessar seus dados, retificá-los, atualizá-los e pedir sua exclusão. Para exercê-los, escreva para adonaielectrical2026@gmail.com. Você também pode apresentar reclamação à Unidade Reguladora e de Controle de Dados Pessoais (URCDP).",
        "Última actualización: setiembre de 2026.": "Última atualização: setembro de 2026.",
        "Términos de uso": "Termos de uso",
        "Alcance de la información. Los contenidos de este sitio son de carácter general. Las descripciones de servicios, los plazos y las imágenes no constituyen una oferta vinculante: cada trabajo se define en un presupuesto individual, con su alcance, precio y condiciones, que se confirma antes de comenzar.": "Alcance da informação. O conteúdo deste site é de caráter geral. As descrições de serviços, os prazos e as imagens não constituem oferta vinculante: cada trabalho é definido em um orçamento individual, com escopo, preço e condições próprios, confirmado antes de começar.",
        "Contenido técnico. Los planos, esquemas y explicaciones técnicas que se muestran son material de referencia de trabajos propios. No sustituyen un relevamiento en obra ni un proyecto firmado, y no deben tomarse como guía para ejecutar una instalación por cuenta propia. Toda instalación que se conecte a las redes de UTE debe ser ejecutada por una firma instaladora y un técnico registrados.": "Conteúdo técnico. As plantas, esquemas e explicações técnicas exibidas são material de referência de trabalhos próprios. Não substituem um levantamento em obra nem um projeto assinado, e não devem ser usados como guia para executar uma instalação por conta própria. Toda instalação ligada às redes da UTE deve ser executada por uma empresa instaladora e um técnico registrados.",
        "Galería de trabajos. Las fotografías son registros de trabajos realizados. Cuando aparecen junto a un plano son ejemplos independientes: no documentan la ejecución de ese plano en particular.": "Galeria de trabalhos. As fotografias são registros de trabalhos realizados. Quando aparecem ao lado de uma planta são exemplos independentes: não documentam a execução daquela planta em particular.",
        "Disponibilidad y emergencias. El servicio de emergencias se atiende las 24 horas, todos los días, sujeto a la disponibilidad del equipo y a la distancia del lugar. Los horarios de atención administrativa son los publicados en la sección Contacto.": "Disponibilidade e emergências. O serviço de emergências é atendido 24 horas por dia, todos os dias, sujeito à disponibilidade da equipe e à distância do local. Os horários de atendimento administrativo são os publicados na seção Contato.",
        "Propiedad intelectual. El nombre ADONAI ELECTRICAL, su logotipo, sus textos y sus imágenes son propiedad de la empresa y no pueden reproducirse ni utilizarse sin autorización escrita.": "Propriedade intelectual. O nome ADONAI ELECTRICAL, seu logotipo, seus textos e suas imagens são propriedade da empresa e não podem ser reproduzidos nem utilizados sem autorização por escrito.",
        "Enlaces externos. El sitio enlaza a plataformas de terceros —WhatsApp, Instagram, Facebook y Google Maps— sobre cuyo contenido y disponibilidad no tenemos control.": "Links externos. O site tem links para plataformas de terceiros — WhatsApp, Instagram, Facebook e Google Maps — sobre cujo conteúdo e disponibilidade não temos controle.",
        "Ley aplicable. Estas condiciones se rigen por la legislación de la República Oriental del Uruguay.": "Lei aplicável. Estas condições regem-se pela legislação da República Oriental do Uruguai."
  });
      ...
      const legalText = {
        privacy: {
          ...
          paragraphs: [
            ...
            "Qué datos pedimos y para qué. Los datos que completás en el formulario —nombre, teléfono, tu correo si lo dejás y el texto de la consulta— se usan únicamente para responderte, evaluar el trabajo y preparar un presupuesto. No los vendemos, no los cedemos con fines comerciales y no los usamos para publicidad.",
            "Cómo se envía tu consulta. El formulario no envía nada por sí solo: arma el mensaje y abre WhatsApp en tu dispositivo para que lo mandes vos. Recién cuando lo enviás, el mensaje viaja por WhatsApp y queda sujeto también a las políticas de esa plataforma. Si preferís no usar WhatsApp, podés escribirnos por correo o llamarnos.",
            "Qué guarda este sitio en tu navegador. No usamos cookies ni herramientas de analítica o publicidad. El sitio guarda en tu propio dispositivo dos preferencias, el idioma y el tema claro u oscuro, que no te identifican y podés borrar limpiando los datos del navegador.",
            "Servicios de terceros. La tipografía se carga desde Google Fonts, por lo que tu dirección IP llega a los servidores de Google al abrir la página. Los enlaces a WhatsApp, Instagram, Facebook y Google Maps te llevan a sitios externos con sus propias políticas.",
            "Cuánto tiempo los conservamos. Las consultas se conservan mientras dure la relación comercial y el plazo en que puedan derivarse responsabilidades por el trabajo realizado. Después se eliminan.",
            "Tus derechos. La Ley N° 18.331 de Protección de Datos Personales te da derecho a acceder a tus datos, rectificarlos, actualizarlos y pedir que se supriman. Para ejercerlos, escribinos a adonaielectrical2026@gmail.com. También podés presentar un reclamo ante la Unidad Reguladora y de Control de Datos Personales (URCDP).",
        ...
        terms: {
          ...
          paragraphs: [
            "Alcance de la información. Los contenidos de este sitio son de carácter general. Las descripciones de servicios, los plazos y las imágenes no constituyen una oferta vinculante: cada trabajo se define en un presupuesto individual, con su alcance, precio y condiciones, que se confirma antes de comenzar.",
            "Contenido técnico. Los planos, esquemas y explicaciones técnicas que se muestran son material de referencia de trabajos propios. No sustituyen un relevamiento en obra ni un proyecto firmado, y no deben tomarse como guía para ejecutar una instalación por cuenta propia. Toda instalación que se conecte a las redes de UTE debe ser ejecutada por una firma instaladora y un técnico registrados.",
            "Galería de trabajos. Las fotografías son registros de trabajos realizados. Cuando aparecen junto a un plano son ejemplos independientes: no documentan la ejecución de ese plano en particular.",
            "Disponibilidad y emergencias. El servicio de emergencias se atiende las 24 horas, todos los días, sujeto a la disponibilidad del equipo y a la distancia del lugar. Los horarios de atención administrativa son los publicados en la sección Contacto.",
            "Propiedad intelectual. El nombre ADONAI ELECTRICAL, su logotipo, sus textos y sus imágenes son propiedad de la empresa y no pueden reproducirse ni utilizarse sin autorización escrita.",
            "Enlaces externos. El sitio enlaza a plataformas de terceros —WhatsApp, Instagram, Facebook y Google Maps— sobre cuyo contenido y disponibilidad no tenemos control.",
            "Ley aplicable. Estas condiciones se rigen por la legislación de la República Oriental del Uruguay.",
            "Última actualización: setiembre de 2026."
          ]
        }
      };
